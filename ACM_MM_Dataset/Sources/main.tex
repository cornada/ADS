...
The cross-national structure also enables a transfer task (train on MIT, predict other universities), which we analyze qualitatively via latent space geometry in Section~\ref{subsec:latent}.
...
The dataset spans {\NumCountries} countries but remains US-heavy (73\% of courses); O*NET reflects US labor market structure; MISIS includes Russian-language descriptions alongside English competency codes.
...
The complete dataset, collection scripts, and evaluation code are available at \url{https://doi.org/10.5281/zenodo.18522759}, with annual updates planned as OCW releases new content.
